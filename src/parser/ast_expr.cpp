...
IROperand ASTIntLiteral::accept(IRGenerator& visitor)
{
...
IROperand ASTDoubleLiteral::accept(IRGenerator& visitor)
{
...
IROperand ASTCharLiteral::accept(IRGenerator& visitor)
{
...
IROperand ASTBoolLiteral::accept(IRGenerator& visitor)
{
...
IROperand ASTIdentifier::accept(IRGenerator& visitor)
{
...
IROperand ASTAssign::accept(IRGenerator& visitor)
{
...
IROperand ASTLogical::accept(IRGenerator& visitor)
{
...
IROperand ASTBinaryExpr::accept(IRGenerator& visitor)
{
...
IROperand ASTUnaryExpr::accept(IRGenerator& visitor)
{
	return visitor.visitUnaryExpr(*this);
}

bool ASTUnaryExpr::isLValue() const
{
	// deref should usually be a valid l-value, will need to check in later pass though
	if (this->op.type == TokenType::Asterisk)
		return true;
...
IROperand ASTCall::accept(IRGenerator& visitor)
{
...
IROperand ASTGroupExpr::accept(IRGenerator& visitor)
{
...
IROperand ASTPostfix::accept(IRGenerator& visitor)
{
...
IROperand ASTArgument::accept(IRGenerator& visitor)
{
...
IROperand ASTCast::accept(IRGenerator& visitor)
{
...
IROperand ASTArrayAccess::accept(IRGenerator& visitor)
{
	return visitor.visitArrayAccess(*this);
}

ASTFieldAccess::ASTFieldAccess(ASTExpr* structExpr, Token fieldIdentifier)
{
	this->structExpr = structExpr;
	this->fieldIdentifier = fieldIdentifier;
}

bool ASTFieldAccess::operator==(const ASTNode& other) const
{
	if (const ASTFieldAccess* node = dynamic_cast<const ASTFieldAccess*>(&other))
		return ((astEqual(node->structExpr, this->structExpr)
			&& node->fieldIdentifier.value == this->fieldIdentifier.value));

	return false;
}

void ASTFieldAccess::accept(ASTPrinter visitor, uint32_t depth)
{
	visitor.visitFieldAccess(*this, depth);
}

void ASTFieldAccess::accept(ASTVisitor& visitor)
{
	visitor.visitFieldAccess(*this);
}

IROperand ASTFieldAccess::accept(IRGenerator& visitor)
{
