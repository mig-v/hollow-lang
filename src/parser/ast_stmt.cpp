...
IROperand ASTVarDecl::accept(IRGenerator& visitor)
{
	return visitor.visitVarDecl(*this);
}

ASTFuncDecl::ASTFuncDecl(Token funcIdentifier, ASTType* returnType, ASTParamList* params, ASTBlock* body)
{
...
IROperand ASTFuncDecl::accept(IRGenerator& visitor)
{
...
IROperand ASTExprStmt::accept(IRGenerator& visitor)
{
...
IROperand ASTReturn::accept(IRGenerator& visitor)
{
...
IROperand ASTBlock::accept(IRGenerator& visitor)
{
...
IROperand ASTForLoop::accept(IRGenerator& visitor)
{
...
IROperand ASTIfStatement::accept(IRGenerator& visitor)
{
...
IROperand ASTWhileLoop::accept(IRGenerator& visitor)
{
	return visitor.visitWhileLoop(*this);
}

ASTStructDecl::ASTStructDecl(ASTStructType* type)
{
	this->type = type;
	//this->typeInfo = nullptr;
}

bool ASTStructDecl::operator==(const ASTNode& other) const
{
	return false;
}

void ASTStructDecl::accept(ASTPrinter visitor, uint32_t depth)
{
	visitor.visitStructDecl(*this, depth);
}
...
IROperand ASTStructDecl::accept(IRGenerator& visitor)
{
