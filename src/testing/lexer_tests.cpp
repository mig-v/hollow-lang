...
LexerTests::LexerTests()
{
	...
	tokenTypeToStr[(int)TokenType::structKeyword] = "<structKeyword>";
	...
	{ 
		...
		TokenType::structKeyword, TokenType::Semicolon, TokenType::funcKeyword, TokenType::Semicolon,
		...
		TokenType::charKeyword, TokenType::Semicolon, TokenType::continueKeyword, TokenType::Semicolon,
		TokenType::elseKeyword, TokenType::Semicolon, TokenType::Eof 
	};
	...
	{ 
		TokenType::IntLiteral, TokenType::FloatLiteral, TokenType::FloatLiteral, TokenType::CharLiteral,
		TokenType::CharLiteral, TokenType::CharLiteral, TokenType::CharLiteral, TokenType::CharLiteral,
		TokenType::CharLiteral, TokenType::CharLiteral, TokenType::CharLiteral, TokenType::CharLiteral,
		TokenType::CharLiteral, TokenType::trueKeyword, TokenType::falseKeyword, TokenType::Eof 
	};
	...
	{ 
		TokenType::GreaterThan,  TokenType::GreaterThanEq, TokenType::LessThan, TokenType::LessThanEq, 
		TokenType::Assign,  TokenType::Equality, TokenType::LogicalNot,  TokenType::NotEq, 
		TokenType::OpenParen,  TokenType::CloseParen, TokenType::OpenCurly,  TokenType::CloseCurly, 
		TokenType::Colon,  TokenType::Plus, TokenType::Minus,  TokenType::Asterisk, 
		TokenType::ForwardSlash, TokenType::LogicalAnd, TokenType::LogicalOr, TokenType::BitwiseAnd,
		TokenType::BitwiseOr, TokenType::BitwiseXor, TokenType::BitwiseNot, TokenType::BitwiseRightShift,
		TokenType::BitwiseLeftShift, TokenType::Increment, TokenType::Decrement, TokenType::PlusEquals,
		TokenType::MinusEquals, TokenType::TimesEquals, TokenType::DividedEquals, TokenType::DotOperator,
		TokenType::OpenBracket, TokenType::CloseBracket, TokenType::BitwiseAndEquals, TokenType::BitwiseOrEquals,
		TokenType::BitwiseXorEquals, TokenType::BitwiseLeftShiftEquals, TokenType::BitwiseRightShiftEquals, TokenType::Semicolon,
		TokenType::Eof 
	};
	...
	testSuite[TEST_PATH"/lexer_tests/identifiers_test.hollow"].testname = "identifiers_test.hollow";
	testSuite[TEST_PATH"/lexer_tests/identifiers_test.hollow"].expectedTokens =
	{
